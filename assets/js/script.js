...
fetch(todayWeatherUrl)
    ...
    .then(function(data) {
        $('#today_icon').attr('src', 'http://openweathermap.org/img/wn/' + (data.weather[0].icon) + '.png')
        // $('#today_icon').append('<img src= alt="' + data.weather[0].description + '" title="' + data.weather[0].description + '">')
    ...
    .then(function(data) {
        ...
        for ( var i = 0; i < data.list.length; i++) {
            ...
            if (reformatDate === oneDay && noon === '12:00:00') {
                $('#one_day_icon').attr('src', 'http://openweathermap.org/img/wn/' + (data.list[i].weather[0].icon) + '.png')
                // $('#one_day_icon').append('<img alt="' + data.list[i].weather[0].description + '" title="' + data.list[i].weather[0].description + '">')
            ...
            if (reformatDate === twoDays && noon === '12:00:00') {
                $('#two_days_icon').attr('src', 'http://openweathermap.org/img/wn/' + (data.list[i].weather[0].icon) + '.png')
            ...
            if (reformatDate === threeDays && noon === '12:00:00') {
                $('#three_days_icon').attr('src', 'http://openweathermap.org/img/wn/' + (data.list[i].weather[0].icon) + '.png')
            ...
            if (reformatDate === fourDays && noon === '12:00:00') {
                $('#four_days_icon').attr('src', 'http://openweathermap.org/img/wn/' + (data.list[i].weather[0].icon) + '.png')
            ...
            if (reformatDate === fiveDays && noon === '12:00:00') {
                $('#five_days_icon').attr('src', 'http://openweathermap.org/img/wn/' + (data.list[i].weather[0].icon) + '.png')
