    ...
    .then(function(data) {
        ...
        for ( var i = 0; i < data.list.length; i++) {
            ...
            if (reformatDate === oneDay && noon === '12:00:00') {
                $('#one_day_icon').append('<img src="http://openweathermap.org/img/wn/' + (data.list[i].weather[0].icon) + '.png" alt="' + data.list[i].weather[0].description + '" title="' + data.list[i].weather[0].description + '">')
            ...
            if (reformatDate === twoDays && noon === '12:00:00') {
                $('#two_days_icon').append('<img src="http://openweathermap.org/img/wn/' + (data.list[i].weather[0].icon) + '.png" alt="' + data.list[i].weather[0].description + '" title="' + data.list[i].weather[0].description + '">')
